...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            TextField {
                ...
                width: parent.width
                label: qsTr("Entrata")
                placeholderText: qsTr("Inserisci entrata")
            ...
            Row {
                ...
                Button {
                    ...
                    onClicked: {
                        appWindow.addTransaction("income", page.parsedAmount, page.selectedCategoryName(), notesField.text, page.selectedDate.getFullYear(), page.selectedDate.getMonth(), page.selectedDate.getDate())
                        pageStack.pop()
                    }
                }
            }
    ...
    Component.onCompleted: {
        page.syncSelectedCategory(qsTr("Entrata"))
    }
}
